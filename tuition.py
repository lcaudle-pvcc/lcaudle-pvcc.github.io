...
def perform_calculations():
    global tutitionfee, capitalfee, instituationfee, activityfee, totalowed, balance
    if inout == 1:
    ...
    institutionfee = numcredits * RATE_INSTITUION
...
def display_results():
    ...
    print('Instituion Fee    $ ' + str(institutionfee))
